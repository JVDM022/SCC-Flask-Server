...
class Telemetry(db.Model, SerializerMixin):
    ...
    adc = db.Column(db.Integer, nullable=True)
    dtemp_c_per_s = db.Column(db.Float, nullable=True)
    setpoint_c = db.Column(db.Float, nullable=True)
    mode = db.Column(db.Integer, nullable=True)
    heater_pwm = db.Column(db.Integer, nullable=True)
    heating = db.Column(db.Integer, nullable=True)
    heater_lockout = db.Column(db.Integer, nullable=True)
    pump_enabled = db.Column(db.Integer, nullable=True)
    pump_allowed = db.Column(db.Integer, nullable=True)
    pump_on = db.Column(db.Integer, nullable=True)
    motor_pwm = db.Column(db.Integer, nullable=True)
    motor_on_ms = db.Column(db.Integer, nullable=True)
    motor_period_ms = db.Column(db.Integer, nullable=True)
    ...
    manual_kill = db.Column(db.Integer, nullable=True)
    hard_kill = db.Column(db.Integer, nullable=True)
...
class MpcRecommendation(db.Model, SerializerMixin):
    ...
    setpoint_c = db.Column(db.Float, nullable=True)
    current_pwm = db.Column(db.Integer, nullable=True)
    recommended_pwm = db.Column(db.Integer, nullable=True)
